...
namespace TP2_Tanguay_Zachary.Models
{
    public class Database
    {
        ...
        public Database()
        {
            ...
            //Listes des enfants.
            Enfants.Add(new Enfant() { Id = 1, NomComplet = "Inconnue", Nom = "Vesemir", Surnom = "Aucun", IdParent = 3, Role = "Sorceleur" , ImageURL1 = "/images/Vesemir_1.jpg", ImageURL2 = "/images/Vesemir_2.jpg", ImageURL3 = "/images/Vesemir_3.jpg", Description = DescVesemir, Genre = "Masculin", Race = "Human", Vedette = true, Age = 168 });
            ...
            Enfants.Add(new Enfant() { Id = 5, NomComplet = "Emhyr var Emreis, Deithwen Addan yn Carn aep Morvudd", Nom = "Emhyr", Surnom = "Duny, Urcheon of Erlenwald", IdParent = 1, Role = "Roi", ImageURL1 = "/images/Emphyr_1.webp", ImageURL2 = "/images/Emphyr_2.webp", ImageURL3 = "/images/Emphyr_3.jpg", Description = DescEmyr, Genre = "Masculin", Vedette = false, Age = 51 });

            Enfants.Add(new Enfant() { Id = 6, NomComplet = "Eredin Bréacc Glas", Nom = "Eredin", Surnom = "The Wild Hunt", IdParent = 1, Role = "Roi" , ImageURL1 = " /images/Eredin_1.webp", ImageURL2 = "/images/Eredin_2.jpg", ImageURL3 = "/images/Eredin_3.jpg", Description = DescEredin, Genre = "Masculin", Vedette = false, Age = 50 });

            Enfants.Add(new Enfant() { Id = 7, NomComplet = "Yennefer de Vengerberg", Nom = "Yennefer", Surnom = "Janka, Jenny, Yenna, Yen, Horsewoman of War", IdParent = 2, Role = "Magicienne", ImageURL1 = "/images/Yen_2.webp", ImageURL2 = "/images/Yen_3.jpg", ImageURL3 = "/images/Yen_4.jpg", Description = DescYennefer, Genre = "Féminin", Vedette = true, Age = 94 });

            Enfants.Add(new Enfant() { Id = 8, NomComplet = "Triss Merigold", Nom = "Triss", Surnom = "Fourteenth of the Hill, Merigold the Fearless", IdParent = 2, Role = "Magicienne" , ImageURL1 = " /images/Triss_1.jpg", ImageURL2 = "/images/Triss_2.jpg", ImageURL3 = "/images/Triss_3.jpg", Description = DescTriss, Genre = "Féminin", Vedette = true, Age = 80 });

            Enfants.Add(new Enfant() { Id = 9, NomComplet = "Keira Metz", Nom = "Keira", Surnom = "Aucun", IdParent = 2, Role = "Magicienne" , ImageURL1 = "/images/Keira_1.jpg", ImageURL2 = "/images/Keira_2.jpg", ImageURL3 = "/images/Keira_3.jpg", Description = DescKeira, Genre = "Féminin", Vedette = false, Age = 71 });

            Enfants.Add(new Enfant() { Id = 10, NomComplet = "Cirilla Fiona Elen Riannon", Nom = "Ciri", Surnom = "Lion Cub of Cintra, Falka, Zireael, Swallow, Ashen one, Ugly one, Lady of Space and Time, Ciri of Vengerberg", IdParent = 3, Role = "Sorceleuse" , ImageURL1 = " /images/Ciri_1.webp", ImageURL2 = "/images/Ciri_2.jpg", ImageURL3 = "/images/Ciri_3.jpg", Description = DescCiri, Genre = "Féminin", Vedette = true, Age = 19 });

            Enfants.Add(new Enfant() { Id = 11, NomComplet = "Crevan Espane aep Caomhan Macha", Nom = "Avallac'h", Surnom = "Fox, The Mysterious Elf", IdParent = 2, Role = "Magicien" ,ImageURL1 = "/images/Avallac_1.jpg", ImageURL2 = "/images/Avallac_2.webp", ImageURL3 = "/images/Avallac_3.jpg", Description = DescAvallac, Genre = "Masculin", Vedette = false, Age = 100 });

            Enfants.Add(new Enfant() { Id = 12, NomComplet = "Cerys an Craite", Nom = "Cerys", Surnom = "Sparrowhawk", IdParent = 1, Role = "Reine" , ImageURL1 = "/images/Cerys_1.jpg", ImageURL2 = "/images/Cerys_2.jpg", ImageURL3 = "/images/Cerys_3.jpg", Description = DescCerys, Genre = "Féminin", Vedette = false, Age = 100 });
